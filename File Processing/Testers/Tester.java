...
public class Tester {
	 ...
	 */
	private static final String TEST_INPUT_DIR = "/Users/isaacdelarosa/" +
			"Desktop/Ex6Test/tests/";
	private static String TEST_TESTERS = "command_line_tests.txt";

	private static final String TEST_OUTPUT_DIR = "/Users/isaacdelarosa/" +
			"Desktop/Ex6Test/outputs/"; 

	private String sourceDir;
	private String commandFile;
	private String numOfTest;
	/**
	 * A constructor that receives a test file input and reads its
	 *  lines to get the  description, source directory and the command file.
	 * @param fileName
	...
	public Ex6Tester(String fileName) throws FileNotFoundException {
		...
		//creates directory named outputs in order to see your solutions.
	 ...
	 * @return a collection of arrays containing a single string 
	...
	/**
	 * Run the main class of MyFileScript with different args input
	 *  (source directory and command file).
	 * @param 
	 * @throws IOException 
	 */
	@Test
	...
	private void compareTextFiles() throws IOException {
		...
		Integer numLine = 0;
		// My output
		File student = new File("outputs/"+numOfTest+".txt");
		//expected output
		File school = new File(TEST_OUTPUT_DIR+numOfTest+".txt");
		...
		while (line2 != null && line1 != null)
		{
			...
			numLine++;
			assertEquals("problem in test number:"+numOfTest+"," +
					" line number:"+numLine,line2,line1);
